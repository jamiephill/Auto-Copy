...
function addToBlockList() {
  ...
  const selectionD = document.getElementById("blocklistDomain").checked;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("alertOnCopyDuration").addEventListener("blur", () => {
    validateNumberValue("alertOnCopyDuration", .75);
  });
  document.getElementById("includeCommentWordCount").addEventListener("blur", () => {
    validateNumberValue("includeCommentWordCount", 5);
  });
  document.getElementById("includeCommentWordCountEnabled").addEventListener("click", () => {
    validateNumberValue("includeCommentWordCount", 5);
  });
  ...
  document.getElementById("includeCommentWordCount").addEventListener(
    "click",
    document.getElementById("includeCommentWordCount").select
  );
  document.getElementById("includeCommentFormat").addEventListener(
    "click",
    document.getElementById("includeCommentFormat").select
  );
